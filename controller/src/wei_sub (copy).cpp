...
const double f_along = (dwall + 0.45); // front進沿牆，加多少根據經驗可修改
const double s_along = (dwall + 0.50); // side,加多少根據經驗可修改
...
class cmd_sub_pub
{
   ...
   public:
      ...
      void check_danger(int jj)
      {
         ...
         bool left_danger = (laser_temp[195] <= 0.5) || (laser_temp[245] <= 0.55) || (laser_temp[225] <= 0.55) /*||(laser_temp[270] < danger_threshold1 && laser_temp[245] < danger_threshold2 && laser_temp[225] < danger_threshold3)*/;
         bool right_danger = (laser_temp[165] <= 0.5) ||(laser_temp[115] <= 0.55) || (laser_temp[135] <= 0.55) /*|| (laser_temp[90] < danger_threshold1 && laser_temp[115] < danger_threshold2 && laser_temp[135] < danger_threshold3)*/;
