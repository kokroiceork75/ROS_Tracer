...
#define load_data_FC_1 "/home/user/wei_ws/src/controller/src/fuzzy_controller/along_wall_controller/temp_ad2-2.txt"  // wei for max speed = 50.0 rad/s
...
///////////////////////////////////  Open the file from leaning ///////////////////////////////
		...
		void test_open()
		{
			...
			// **根據狹窄通道模式切換不同的控制器檔案**
			const char *selected_FC = is_narrow_passage ? load_data_FC_2 : load_data_FC_1;
