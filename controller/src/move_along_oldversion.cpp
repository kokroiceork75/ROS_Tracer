...
#define load_data_FC "/home/user/wei_ws/src/controller/src/fuzzy_controller/along_wall_controller/temp_w33-2.txt"  // wei for max speed = 50.0 rad/s
...
double v1;
double v2;
int decision_left =0,decision_right =1;
